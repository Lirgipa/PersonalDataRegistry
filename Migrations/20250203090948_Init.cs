        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PhoneNumbers_PersonEntities_PersonId",
                        column: x => x.PersonId,
                        principalTable: "PersonEntities",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RelatedPersons_PersonEntities_PersonId",
                        column: x => x.PersonId,
                        principalTable: "PersonEntities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RelatedPersons_PersonEntities_RelatedPersonId",
